            ...
            <form method="POST" action="{{ route('cart.store') }}">
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input nome="endereco" type="text" class="form-control" id="address" placeholder="1234 Main St" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input name="codpostal" type="text" class="form-control" id="zip" placeholder="" required>
                        <div class="invalid-feedback">
                        Zip code required.
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="notes" type="text" class="form-control" id="address" placeholder="" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="custom-control custom-radio">
                        <input id="credit" name="payment_type" type="radio" class="custom-control-input" value="VISA" checked required>
                        <label class="custom-control-label" for="credit">Cartão de crédito VISA</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input id="debit" name="payment_type" type="radio" class="custom-control-input" value="MC" required>
                        <label class="custom-control-label" for="debit">Cartão de crédito Master Card</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input id="paypal" name="payment_type" type="radio" class="custom-control-input" value="PAYPAL" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="payment_ref" type="text" class="form-control" id="NIF" placeholder="" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="nif" type="text" class="form-control" id="NIF" placeholder="" required>
                        <div class="invalid-feedback">
                            NIF is required
                        </div>
                    </div>
